...
class MediaModal {
	constructor (modal = true)
	{
                      ...
                      <div class="filemanager">
						...
						<div class="top-panel">
							...
							<div class="upload collapse">
							   ...
							   <input type="file" multiple class="" accept="image/jpg, image/jpeg, image/png, image/svg">
		...
		this.fileList = null;
		this.mediaPath = "/assets/public/media/";
		this.type = "single";
	}
	...
	showUploadError(error) {
        for(var i = 0; i<error.length; i++){
            ...
            <div class="alert alert-danger">
                <strong>Sorry!</strong> ${error[i]}.
            </div>`;
            $("#MediaModal .upload").append(errMsg);
        }
	}
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if(data.error!==undefined){
                            Vvveb.MediaModal.showUploadError(data.error);
